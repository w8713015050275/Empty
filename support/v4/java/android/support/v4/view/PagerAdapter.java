...
public abstract class PagerAdapter {
    //一般adapter中有一个observable, view中有observer,将observer注册到observable中
    //adapter中数据改变时,adapter通过observable通知observer做出改变
     ...
     */
    //adapter的数据内容发生改变,通知observer, ViewPager中在setAdapter中传入的
