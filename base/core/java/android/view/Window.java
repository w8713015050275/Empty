...
public abstract class Window {
    ...
    public void setWindowManager(WindowManager wm, IBinder appToken, String appName,
        ...
        //通过WindowManager创建WindowManagerImpl对象;重新创建的~~~
    ...
    /**
     * Specify the status bar icon color to use for the window as per
     *  WindowManager.LayoutParams.systemUiIconColor}.
     * @hide
     */
    public void setStatusBarIconColor(int color){
        final WindowManager.LayoutParams attrs = getAttributes();
        if(color != attrs.systemUiIconColor){
            attrs.systemUiIconColor = color;
        }
        dispatchWindowAttributesChanged(attrs);
    }
    ...
    /** @hide */
    public void addLeuiFlags(int flags) {
        setLeuiFlags(flags, flags);
    }
    /**
    ...
    private void setLeuiFlags(int flags, int mask) {
        final WindowManager.LayoutParams attrs = getAttributes();
        attrs.leuiFlags = (attrs.leuiFlags & ~mask) | (flags & mask);
        dispatchWindowAttributesChanged(attrs);
    }
    ...
    //[+LEUI-21622]
    /**
     * This has the same visual effect as {@link #setStatusBarColor(int)}
     * ONLY set by immersive mode
     * see {@link com.letv.leui.util.immersivemode.EuiImmersiveModeManager}
     * @hide
     */
    public void setEuiStatusBarColor(@ColorInt int color){
        //
    }
     ...
     * @hide
     */
    public void setEuiNavigationBarColor(@ColorInt int color){
        //
    }
    //[-LEUI-21622]
