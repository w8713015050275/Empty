...
public final class WindowManagerGlobal {
    ...
    private void invalidateView(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < count; i++) {
                invalidateView(group.getChildAt(i));
            }
        }
    }
	...
	// [+LEUI-9331]
    public void dumpBGInfo(FileDescriptor fd,String processName){
        ...
        try{
            synchronized(mLock){
                ...
                for(int i=0; i < count; i++){
                    ...
                    AttachInfo info = root.getView().mAttachInfo;
                    if(info.mViewRequestingWindowBlur != null){
                        pw.print("  ProcessName = ");pw.println(processName);
                        pw.print("  name = ");pw.println(name);
                        pw.print("  BlurView = ");pw.println(info.mViewRequestingWindowBlur);
                        pw.print("  Window Coordinates =");pw.print("("+info.mWindowLeft);pw.println(","+info.mWindowTop+")");
                        pw.println();
                    }
                }
            }
