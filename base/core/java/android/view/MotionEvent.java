...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    public final int getFlags() {
        int j = nativeGetFlags(mNativePtr);
        if ("com.google.android.packageinstaller".equals(ActivityThread.currentPackageName())||"com.android.packageinstaller".equals(ActivityThread.currentPackageName())) {
            if ((j & 0x3) != 0) {
                Log.i("NoOverlayWarning", "Will Cleared FLAG_WINDOW_IS_PARTIALLY_OBSCURED OR FLAG_WINDOW_IS_OBSCURED flag int=" + j);
                j = j & 0xFFFFFFFC;
            }
        }
