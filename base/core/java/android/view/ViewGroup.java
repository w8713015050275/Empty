...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (onFilterTouchEventForSecurity(ev)) {
            ...
            if (actionMasked == MotionEvent.ACTION_DOWN) {
                ...
                //ACTION_DOWN时,重置disallow intercept标志
            ...
            if (actionMasked == MotionEvent.ACTION_DOWN
                ...
                //ACTION_DOWN时mGroupFlags的允许拦截标志肯定为false
                final boolean disallowIntercept = (mGroupFlags & FLAG_DISALLOW_INTERCEPT) != 0;
                if (!disallowIntercept) {
                    //该ViewGroup可以拦截
                    //ACTION_DOWN时,允许拦截->检测是否拦截
                    ...
                    //如果子view设置父view不允许拦截,事件直接进行路由
                    intercepted = false;
                }
            } else {
                //ACTION_DOWN处理后,如果没有找到处理事件的子View,则认为没有子View处理,则去拦截后续touch序列
                //妈了个鸡,没人处理我就拦截了自己来
                //后边我都自己来
            ...
            //22222222222222222
            //不取消 且 不拦截 -> 去查找处理event的子view,View对应Touch Target
                    ...
                    if (newTouchTarget == null && childrenCount != 0) {
                        ...
                        for (int i = childrenCount - 1; i >= 0; i--) {
                            ...
                            if (dispatchTransformedTouchEvent(ev, false, child, idBitsToAssign)) {
                                ...
                                //赋值mFirstTouchTarget,找到处理event的View
            ...
            if (mFirstTouchTarget == null) {
                ...
                //把touch targets当做普通View对待,无分发操作:自己来的调用方法
                //ViewGroup自己处理
    ...
    private boolean dispatchTransformedTouchEvent(MotionEvent event, boolean cancel,
        ...
        if (cancel || oldAction == MotionEvent.ACTION_CANCEL) {
            ...
            if (child == null) {
                //没人处理自己来的分支, 即View的dispatchTouchEvent()
                handled = super.dispatchTouchEvent(event);
            } else {
                //调用子View的dispatchTouchEvent,可能是View或ViewGroup
    ...
    void offsetRectBetweenParentAndChild(View descendant, Rect rect,
        ...
        if (theParent == this) {
            ...
            ///[BUG][RUBY-26905][zhangxueqiang@letv.com]add log help to find the owner
    ...
    protected void measureChildWithMargins(View child,
        ...
        //使用宇宙标准去get到child的spec; 即是自己本身,也时child的父
        final int childWidthMeasureSpec = getChildMeasureSpec(parentWidthMeasureSpec,
