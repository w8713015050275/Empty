...
public class Intent implements Parcelable, Cloneable {
    ...
    //LEUI-START [REQ][Gain] added
    /**
     * Activity Action: Pick multiple items from the data, returning what was selected.
    ...
    /**
     * LEUI: Add for Calllog
     * @hide
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_VIEW_NUMBER_CALLLOG = "android.intent.action.VIEW_NUMBER_CALLLOG";
     ...
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_VIEW_CONTACT_CALLLOG = "android.intent.action.VIEW_CONTACT_CALLLOG";
    ...
    //LEUI-START [REQ][LEUI-1051] [zhangli] added
    /**
     * add for statusbar,
     * update return to incall screen button view state
     * @hide
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_STATUSBAR_RETURN_INCALL_UPDATE = "android.intent.action.STATUSBAR_RETURN_INCALL_UPDATE";
    //LEUI-END [REQ][LEUI-1051] [zhangli] added
    ...
    //[+leui 7237] gaozhipeng@letv.com 2015.08.06 added
    public static final String ACTION_UPDATE_REALTIME_SPEED = "android.intent.action.UPDATE_REALTIME_SPEED";
    //[-LEUI 7237] gaozhipeng@letv.com
    ...
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_PACKAGE_ADDED_FAILED = "android.intent.action.PACKAGE_ADDED_FAILED";

    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_PACKAGE_DELETE_FAILED =  "android.intent.action.PACKAGE_DELETE_FAILED";
    /**
    ...
    /**
     * Broadcast Action: The current system lock_wallpaper has changed. See
     * {@link android.app.WallpaperManager} for retrieving the new
     * lock_wallpaper.
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
   ...
   /**
    ...
    //LEUI-START [REQ][LEUI-5294] [fengzihua] added: phone control
      /**
       * Send this action to lock screen or other application
       * When phone is locked
       * @hide
       */
      @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
      public static final String ACTION_PHONECONTROL_LOCK_LEUI = "com.letv.leui.action.PHONE_CONTROL_LOCK";
       ...
       */
      @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
      public static final String ACTION_PHONECONTROL_UNLOCK_LEUI = "com.letv.leui.action.PHONE_CONTROL_UNLOCK";
      //LEUI-END [REQ][LEUI-5294] [fengzihua]

      //LEUI-START [REQ][LEUI-5294] [tongtiancheng] added: phone control
      /**
       * Send this action to notify phone control status
       * When phone control power set is completed
       * @hide
       */
      @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
      public static final String ACTION_PHONECONTROL_POWER_LEUI = "com.letv.leui.action.PHONE_CONTROL_POWER_STATUS";
     //LEUI-END [REQ][LEUI-5294] [tongtiancheng]

    //[+LEUI] [CONNECT-12500] [chenxu1] update white list for bgResourceControl
    /**
     * common Control broadcast for bgresource and auto start etc.
     * set flags for different use
     * @hide
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_UPDATE_WHITELIST_LEUI = "com.letv.leui.action.UPDATE_WHITELIST";
    // [-LEUI] [CONNECT-12500] [chenxu1] end
    ...
    /** {@hide} */
    public static final String EXTRA_LEUI_REASON = "android.intent.extra.LEUI_REASON";//wanghailu@letv.com 2014.12.23

    /** {@hide} */
    public static final String EXTRA_WIPE_EXTERNAL_STORAGE = "android.intent.extra.WIPE_EXTERNAL_STORAGE";

    //LEUI-END [REQ][LEUI-13707] [yueshuai]
    /** {@hide} */
    public static final String LEUI_CHECK_ACCESSCONTROL = "android.intent.extra.android.intent.action.LEUI_CHECK_ACCESSCONTROL";
    ...
    /**
        Used for multi function screenshot: this activity could on top of every screenshot
    * @hide
    */
    public static final int FLAG_ACTIVITY_ON_TOP = 0x80000000;
     ...
     * key guard or any other lock screens
     * @see {@link WindowManager.LayoutParams#FLAG_DISMISS_KEYGUARD}
     * @see {@link WindowManager.LayoutParams#FLAG_SHOW_WHEN_LOCKED}
     * @see {@link WindowManager.LayoutParams#LEUI_FLAG_START_FROM_CONTROL_CENTER}
     * @hide
     */
    public static final int FLAG_SHOW_WHEN_LOCKED = 0x00001000;
    ...
    //[+LEUI-26405]
    /**
     * Compatibility:As of API 24(AndroidN) Use below value instead of {@link #FLAG_SHOW_WHEN_LOCKED}
     * @hide
     */
    public static final int EUI_FLAG_SHOW_WHEN_LOCKED = 0x10000000;
    //[+LEUI-26405]

    /**
     * @hide
     */
    public static final int EUI_FLAG_IGNORE_CHECK_ACCESS_CONTROL = 0x00000001;


    //[+LEUI] [REQ][LEUI-13983] [yueshuai] add
    /**
     * @hide
     */
    public static final int EUI_FLAG_REUSE_ACCESS_CONTROL_TASK = 0x00000100;
    //[+LEUI]

    // [+LEUI] [REQ] [LEUI-24922] [yuanguohong] limit apps to launch automatically.
    /**
     * @hide
     */
    public static final int EUI_FLAG_NEED_CHECK_AUTO_LAUNCH_PERMISSION = 0x00000010;
    // [-LEUI]
    ...
    */
     ...
     * @hide
     */
    public Intent setEuiFlags(int flags){
        mEuiFlags = flags;
        return this;
    }
    //[-LEUI-9268]
    ...
    * @hide
    */
    public Intent setArg1(long arg){
        arg1 = arg;
        return this;
    }
    ...
    */
    ...
    //[+LEUI] [REQ][LEUI-8957] [xulei] add 
    //for support double app  
    public Intent setShadow(boolean isShadow){
        mIsShadow = isShadow;
        return this;
    }
     ...
     * @hide
     */
    public Intent addEuiFlags(int flags){
        mEuiFlags |= flags;
        return this;
    }
    //[-LEUI-9268]
    ...
    public void toShortString(StringBuilder b, boolean secure, boolean comp, boolean extras,
        ...
        if(mEuiFlags != 0){
            ...
            first = false;
            b.append("Euiflg=0x").append(Integer.toHexString(mEuiFlags));
        }
        //[-LEUI-9268]
        //[-LEUI-18511]
        if(mCallingUid != 0){
            ...
            first = false;
            b.append("mCallingUid=").append(mCallingUid);
        }
        //[-LEUI-18511]
        if (mPackage != null) {
            if (!first) {
    ...
    public void readFromParcel(Parcel in) {
		...
		//[+LEUI] [REQ][LEUI-8957] [xulei] add 
        //for support double app  
        mIsShadow = in.readInt() == 1 ? true:false;
		//[+LEUI]end
    }
    ...
    //LEUI-START [REQ][LEUI-9047] [fengzihua] added: for brocastQueue
    /**
     * The name of the category used to define the Intent of a shortcut.
     *
     * @hide
     */
    private static final String CATEGORY_LETV_INNER_BG_INTENT = "com.letv.android.intent.extra.inner_bg_INTENT";

    /**
     * Add a special category to the intent,
     * so we can know is an special Intent for add to inner broadcastQueue.
     *
     * @hide
     */
    public void addInnerBgMark() {
        addCategory(CATEGORY_LETV_INNER_BG_INTENT);
    }

    /**
     * is an inner Intent when add to broadcastQueue.
     *
     * @return boolean
     * @hide
     */
    public boolean hasInnerBgMark() {
        return hasCategory(CATEGORY_LETV_INNER_BG_INTENT);
    }

    /**
     * remove the inner Intent mark when add to broadcastQueue.
     *
     * @hide
     */
    public void removeInnerBgMark() {
        removeCategory(CATEGORY_LETV_INNER_BG_INTENT);
    }
   ...
   /**
     * Broadcast Action: system get sale area
     * @hide
     */
    public static final String ACTION_ACQUIRE_SALEAREA = "android.intent.action.LETV_ACQUIRE_SALEAREA";
}
