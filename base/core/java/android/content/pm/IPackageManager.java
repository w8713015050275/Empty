 ...
 */
//该文件位置: out/target/common/obj/JAVA_LIBRARIES/framework_intermediates/src/core/java/android/content/pm
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageManager {
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_getCloneResolveInfo: {
                    data.enforceInterface(DESCRIPTOR);
                    android.content.pm.ResolveInfo _arg0;
                    //取出方法参数值
                    if ((0 != data.readInt())) {
                        _arg0 = android.content.pm.ResolveInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                    //执行方法;返回结果放到_result中
                    //该方法的实现在哪里???当然在PackageManagerService中
                    android.content.pm.ResolveInfo _result = this.getCloneResolveInfo(_arg0);
                ...
                case TRANSACTION_isAppDouble: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    boolean _result = this.isAppDouble(_arg0);
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
                case TRANSACTION_isSameSignsApps: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    java.lang.String _arg1;
                    _arg1 = data.readString();
                    boolean _result = this.isSameSignsApps(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
                ...
                case TRANSACTION_recoverySystemInstallPackage: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    this.recoverySystemInstallPackage(_arg0);
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_pmScanPackageLI: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    int _arg1;
                    ...
                    long _arg3;
                    _arg3 = data.readLong();
                    this.pmScanPackageLI(_arg0, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_registerLaunchedObserver: {
                    data.enforceInterface(DESCRIPTOR);
                    android.content.pm.ILaunchObserver _arg0;
                    _arg0 = android.content.pm.ILaunchObserver.Stub.asInterface(data.readStrongBinder());
                    this.registerLaunchedObserver(_arg0);
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_unRegisterLaunchedObserver: {
                    data.enforceInterface(DESCRIPTOR);
                    this.unRegisterLaunchedObserver();
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_setLaunchedPackage: {
                    data.enforceInterface(DESCRIPTOR);
                    android.content.Intent _arg0;
                    if ((0 != data.readInt())) {
                        _arg0 = android.content.Intent.CREATOR.createFromParcel(data);
                    ...
                    java.lang.String _arg1;
                    _arg1 = data.readString();
                    this.setLaunchedPackage(_arg0, _arg1);
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_adbDialog: {
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result = this.adbDialog();
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
                case TRANSACTION_authentificationFeatureMap: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    java.lang.String _arg1;
                    ...
                    java.lang.String _arg2;
                    _arg2 = data.readString();
                    boolean _result = this.authentificationFeatureMap(_arg0, _arg1, _arg2);
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
                case TRANSACTION_getFeatureMap: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    java.lang.String _arg1;
                    _arg1 = data.readString();
                    java.util.List<java.lang.String> _result = this.getFeatureMap(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeStringList(_result);
                    return true;
                }
                case TRANSACTION_setPermByList: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    boolean _arg1;
                    _arg1 = (0 != data.readInt());
                    boolean _result = this.setPermByList(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
                case TRANSACTION_queryDefaultPreferredActivity: {
                    data.enforceInterface(DESCRIPTOR);
                    android.content.Intent _arg0;
                    if ((0 != data.readInt())) {
                        _arg0 = android.content.Intent.CREATOR.createFromParcel(data);
                    ...
                    int _arg3;
                    _arg3 = data.readInt();
                    android.content.pm.ResolveInfo _result = this.queryDefaultPreferredActivity(_arg0, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    if ((_result != null)) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                ...
                case TRANSACTION_clearSystemCache: {
                    data.enforceInterface(DESCRIPTOR);
                    android.content.pm.IPackageDataObserver _arg0;
                    _arg0 = android.content.pm.IPackageDataObserver.Stub.asInterface(data.readStrongBinder());
                    this.clearSystemCache(_arg0);
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_onBootPhase: {
                    data.enforceInterface(DESCRIPTOR);
                    this.onBootPhase();
                    reply.writeNoException();
                    return true;
                }
                case TRANSACTION_getAccessCtrlResolveInfo: {
                    data.enforceInterface(DESCRIPTOR);
                    int _arg0;
                    _arg0 = data.readInt();
                    android.content.pm.ResolveInfo _result = this.getAccessCtrlResolveInfo(_arg0);
                    reply.writeNoException();
                    if ((_result != null)) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
                ...
                case TRANSACTION_getLastDisabledAppCaller: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    int _arg1;
                    _arg1 = data.readInt();
                    java.lang.String _result = this.getLastDisabledAppCaller(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                }
                case TRANSACTION_getInstallingPackageState: {
                    data.enforceInterface(DESCRIPTOR);
                    java.lang.String _arg0;
                    _arg0 = data.readString();
                    boolean _result = this.getInstallingPackageState(_arg0);
                    reply.writeNoException();
                    reply.writeInt(((_result) ? (1) : (0)));
                    return true;
                }
...
//for support double app
            ...
            @Override
            public android.content.pm.ResolveInfo getCloneResolveInfo(android.content.pm.ResolveInfo rInfo) throws android.os.RemoteException {
                ...
                try {
                    ...
                    if ((rInfo != null)) {
                        _data.writeInt(1);
                        rInfo.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    //客户端发起远程调用;当前线程挂起;参数写入_data
                    //返回时线程继续执行;
                    //返回结果放在_replay中
                    mRemote.transact(Stub.TRANSACTION_getCloneResolveInfo, _data, _reply, 0);
            ...
            @Override
            public boolean isAppDouble(java.lang.String packageName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    ...
                    mRemote.transact(Stub.TRANSACTION_isAppDouble, _data, _reply, 0);
                    _reply.readException();
...
//[+LEUI]end
// [+LEUI] [REQ] [LEUI-13225] [xulei] added:feature for limit background apps.

            @Override
            public boolean isSameSignsApps(java.lang.String pkg1, java.lang.String pkg2) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    ...
                    mRemote.transact(Stub.TRANSACTION_isSameSignsApps, _data, _reply, 0);
                    _reply.readException();
                    _result = (0 != _reply.readInt());
                } finally {
                    _reply.recycle();
...
// [+LEUI] [REQ][LEUI-6228] [zhaowanxiang] added
// function: reboot and update the updateota.zip

            @Override
            public void recoverySystemInstallPackage(java.lang.String packagepath) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(packagepath);
                    mRemote.transact(Stub.TRANSACTION_recoverySystemInstallPackage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
// [-LEUI]
// [+LEUI] [REQ][LEUI-6231] [zhaowanxiang] added
// function: When adb push a system apk, which can be installed

            @Override
            public void pmScanPackageLI(java.lang.String scanFile, int parseFlags, int scanFlags, long currentTime) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(scanFile);
                    _data.writeInt(parseFlags);
                    _data.writeInt(scanFlags);
                    _data.writeLong(currentTime);
                    mRemote.transact(Stub.TRANSACTION_pmScanPackageLI, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
//[-LEUI]
// [+LEUI] [REQ][LEUI-5820] [zhaowanxiang] added for have callback interface for user get this pacakge be launched

            @Override
            public void registerLaunchedObserver(android.content.pm.ILaunchObserver launchObserver) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeStrongBinder((((launchObserver != null)) ? (launchObserver.asBinder()) : (null)));
                    mRemote.transact(Stub.TRANSACTION_registerLaunchedObserver, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            @Override
            public void unRegisterLaunchedObserver() throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_unRegisterLaunchedObserver, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            @Override
            public void setLaunchedPackage(android.content.Intent intent, java.lang.String packageName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    ...
                    _data.writeString(packageName);
                    mRemote.transact(Stub.TRANSACTION_setLaunchedPackage, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
//[-LEUI]
// [+LEUI] [REQ][LEUI-5780] [zhaowanxiang] modify
// function : when adb install the app ,show the LeBottomSheet

            @Override
            public boolean adbDialog() throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_adbDialog, _data, _reply, 0);
                    _reply.readException();
                    _result = (0 != _reply.readInt());
                } finally {
                    _reply.recycle();
...
//[-LEUI]
//[+LEUI] [REQ] [LEUI-9246] [wanghailu] added for FeatureMap 2015.03.28

            @Override
            public boolean authentificationFeatureMap(java.lang.String feature, java.lang.String type, java.lang.String mapName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    ...
                    _data.writeString(mapName);
                    mRemote.transact(Stub.TRANSACTION_authentificationFeatureMap, _data, _reply, 0);
                    _reply.readException();
                    _result = (0 != _reply.readInt());
                } finally {
                    _reply.recycle();
...
//[-LEUI]
// [+LEUI] [REQ][SI-12708] [zhaowanxiang] add 2015.4.4
// function: Open the list interface of get list

            @Override
            public java.util.List<java.lang.String> getFeatureMap(java.lang.String feature, java.lang.String type) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                ...
                try {
                    ...
                    _data.writeString(feature);
                    _data.writeString(type);
                    mRemote.transact(Stub.TRANSACTION_getFeatureMap, _data, _reply, 0);
                    _reply.readException();
...
// [-LEUI]
// [+LEUI] [REQ][SI-13240] [zhaowanxiang] add 2015.4.10
// function: Add white list for install app by adb or appstore

            @Override
            public boolean setPermByList(java.lang.String PackageName, boolean isNew) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(PackageName);
                    _data.writeInt(((isNew) ? (1) : (0)));
                    mRemote.transact(Stub.TRANSACTION_setPermByList, _data, _reply, 0);
                    _reply.readException();
                    _result = (0 != _reply.readInt());
                } finally {
                    _reply.recycle();
...
// [-LEUI]
// [+LEUI] [REQ][SI-14492] [zhaowanxiang] add 2015.4.22
// function: Get default preferred Activity

            @Override
            public android.content.pm.ResolveInfo queryDefaultPreferredActivity(android.content.Intent intent, java.lang.String resolvedType, int flags, int userId) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                android.content.pm.ResolveInfo _result;
                try {
                    ...
                    _data.writeInt(flags);
                    _data.writeInt(userId);
                    mRemote.transact(Stub.TRANSACTION_queryDefaultPreferredActivity, _data, _reply, 0);
                    _reply.readException();
                    if ((0 != _reply.readInt())) {
                        _result = android.content.pm.ResolveInfo.CREATOR.createFromParcel(_reply);
                    } else {
...
// [-LEUI]
// [+LEUI] [REQ][MOBILEP-12536] [baibaolei] add 2015.6.04
// function: clear system /cache/backup folder

            @Override
            public void clearSystemCache(android.content.pm.IPackageDataObserver observer) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeStrongBinder((((observer != null)) ? (observer.asBinder()) : (null)));
                    mRemote.transact(Stub.TRANSACTION_clearSystemCache, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
// [-LEUI]
// [+LEUI] [REQ][SI-17661] [zhaowanxiang] add 2015.7.7
// function: Repaired  state exception of setupwizard,this is the boot complete of android

            @Override
            public void onBootPhase() throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_onBootPhase, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
...
//[+LEUI-9268]
            ...
            @Override
            public android.content.pm.ResolveInfo getAccessCtrlResolveInfo(int userId) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                android.content.pm.ResolveInfo _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeInt(userId);
                    mRemote.transact(Stub.TRANSACTION_getAccessCtrlResolveInfo, _data, _reply, 0);
                    _reply.readException();
                    if ((0 != _reply.readInt())) {
                        _result = android.content.pm.ResolveInfo.CREATOR.createFromParcel(_reply);
                    } else {
...
//[-LEUI-9268]
// [+LEUI] [REQ][LEUI-13264] [luochen1] add for disable app function in SuperManager

            @Override
            public java.lang.String getLastDisabledAppCaller(java.lang.String packageName, int userId) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                java.lang.String _result;
                try {
                    ...
                    _data.writeString(packageName);
                    _data.writeInt(userId);
                    mRemote.transact(Stub.TRANSACTION_getLastDisabledAppCaller, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
...
// [-LEUI]
// [+LEUI] [REQ][LEUI-12173] [zhaowanxiang] add 2015.1.26
// function: Get the state of installing package

            @Override
            public boolean getInstallingPackageState(java.lang.String PackageName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                boolean _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(PackageName);
                    mRemote.transact(Stub.TRANSACTION_getInstallingPackageState, _data, _reply, 0);
                    _reply.readException();
                    _result = (0 != _reply.readInt());
                } finally {
                    _reply.recycle();
        ...
        static final int TRANSACTION_getCloneResolveInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
        static final int TRANSACTION_isAppDouble = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
        static final int TRANSACTION_isSameSignsApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
        static final int TRANSACTION_isPackageFrozen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
        static final int TRANSACTION_isPackageAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
        static final int TRANSACTION_getPackageInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
        static final int TRANSACTION_getPackageUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
        static final int TRANSACTION_getPackageUidEtc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
        static final int TRANSACTION_getPackageGids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
        static final int TRANSACTION_getPackageGidsEtc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
        static final int TRANSACTION_currentToCanonicalPackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
        static final int TRANSACTION_canonicalToCurrentPackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
        static final int TRANSACTION_getPermissionInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
        static final int TRANSACTION_queryPermissionsByGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
        static final int TRANSACTION_getPermissionGroupInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
        static final int TRANSACTION_getAllPermissionGroups = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
        static final int TRANSACTION_getApplicationInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
        static final int TRANSACTION_getActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
        static final int TRANSACTION_activitySupportsIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
        static final int TRANSACTION_getReceiverInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
        static final int TRANSACTION_getServiceInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
        static final int TRANSACTION_getProviderInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
        static final int TRANSACTION_checkPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
        static final int TRANSACTION_checkUidPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
        static final int TRANSACTION_addPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
        static final int TRANSACTION_removePermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
        static final int TRANSACTION_grantRuntimePermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
        static final int TRANSACTION_revokeRuntimePermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
        static final int TRANSACTION_resetRuntimePermissions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
        static final int TRANSACTION_getPermissionFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
        static final int TRANSACTION_updatePermissionFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
        static final int TRANSACTION_updatePermissionFlagsForAllApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
        static final int TRANSACTION_shouldShowRequestPermissionRationale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
        static final int TRANSACTION_isProtectedBroadcast = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
        static final int TRANSACTION_checkSignatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
        static final int TRANSACTION_checkUidSignatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
        ...
        static final int TRANSACTION_getUidForSharedUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
        static final int TRANSACTION_getFlagsForUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
        static final int TRANSACTION_getPrivateFlagsForUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
        static final int TRANSACTION_isUidPrivileged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
        static final int TRANSACTION_getAppOpPermissionPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
        static final int TRANSACTION_resolveIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
        static final int TRANSACTION_canForwardTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
        static final int TRANSACTION_queryIntentActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
        static final int TRANSACTION_queryIntentActivityOptions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
        static final int TRANSACTION_queryIntentReceivers = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
        static final int TRANSACTION_resolveService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
        static final int TRANSACTION_queryIntentServices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
        static final int TRANSACTION_queryIntentContentProviders = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
        static final int TRANSACTION_getInstalledPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
        static final int TRANSACTION_getPackagesHoldingPermissions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
        static final int TRANSACTION_getInstalledApplications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
        static final int TRANSACTION_getPersistentApplications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
        static final int TRANSACTION_resolveContentProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
        static final int TRANSACTION_querySyncProviders = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
        static final int TRANSACTION_queryContentProviders = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
        static final int TRANSACTION_getInstrumentationInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
        static final int TRANSACTION_queryInstrumentation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
        static final int TRANSACTION_installPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
        static final int TRANSACTION_installPackageAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
        ...
        static final int TRANSACTION_deletePackageAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
        static final int TRANSACTION_deletePackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
        static final int TRANSACTION_getInstallerPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
        static final int TRANSACTION_addPackageToPreferred = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
        static final int TRANSACTION_removePackageFromPreferred = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
        static final int TRANSACTION_getPreferredPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
        static final int TRANSACTION_resetApplicationPreferences = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
        static final int TRANSACTION_getLastChosenActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
        static final int TRANSACTION_setLastChosenActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
        static final int TRANSACTION_addPreferredActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
        static final int TRANSACTION_replacePreferredActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
        static final int TRANSACTION_clearPackagePreferredActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
        static final int TRANSACTION_getPreferredActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
        static final int TRANSACTION_addPersistentPreferredActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
        static final int TRANSACTION_clearPackagePersistentPreferredActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
        ...
        static final int TRANSACTION_getPreferredActivityBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
        static final int TRANSACTION_restorePreferredActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
        static final int TRANSACTION_getDefaultAppsBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
        static final int TRANSACTION_restoreDefaultApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
        static final int TRANSACTION_getIntentFilterVerificationBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
        static final int TRANSACTION_restoreIntentFilterVerification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
        ...
        static final int TRANSACTION_setPackageStoppedState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
        static final int TRANSACTION_freeStorageAndNotify = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
        static final int TRANSACTION_freeStorage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
        static final int TRANSACTION_deleteApplicationCacheFiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
        static final int TRANSACTION_clearApplicationUserData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
        static final int TRANSACTION_getPackageSizeInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
        static final int TRANSACTION_getSystemSharedLibraryNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
        static final int TRANSACTION_getSystemAvailableFeatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
        static final int TRANSACTION_hasSystemFeature = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
        static final int TRANSACTION_enterSafeMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
        static final int TRANSACTION_isSafeMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
        static final int TRANSACTION_systemReady = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
        static final int TRANSACTION_hasSystemUidErrors = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
        static final int TRANSACTION_performBootDexOpt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
        static final int TRANSACTION_performDexOptIfNeeded = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
        static final int TRANSACTION_forceDexOpt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
        static final int TRANSACTION_updateExternalMediaStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
        static final int TRANSACTION_nextPackageToClean = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
        static final int TRANSACTION_getMoveStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
        static final int TRANSACTION_registerMoveCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
        static final int TRANSACTION_unregisterMoveCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
        static final int TRANSACTION_movePackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
        static final int TRANSACTION_movePrimaryStorage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 114);
        static final int TRANSACTION_addPermissionAsync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 115);
        static final int TRANSACTION_setInstallLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 116);
        static final int TRANSACTION_getInstallLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 117);
        static final int TRANSACTION_installExistingPackageAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 118);
        static final int TRANSACTION_verifyPendingInstall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 119);
        static final int TRANSACTION_extendVerificationTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 120);
        static final int TRANSACTION_verifyIntentFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 121);
        static final int TRANSACTION_getIntentVerificationStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 122);
        static final int TRANSACTION_updateIntentVerificationStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 123);
        static final int TRANSACTION_getIntentFilterVerifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 124);
        static final int TRANSACTION_getAllIntentFilters = (android.os.IBinder.FIRST_CALL_TRANSACTION + 125);
        static final int TRANSACTION_setDefaultBrowserPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 126);
        static final int TRANSACTION_getDefaultBrowserPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 127);
        static final int TRANSACTION_getVerifierDeviceIdentity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 128);
        static final int TRANSACTION_isFirstBoot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 129);
        static final int TRANSACTION_isOnlyCoreApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 130);
        static final int TRANSACTION_isUpgrade = (android.os.IBinder.FIRST_CALL_TRANSACTION + 131);
        static final int TRANSACTION_setPermissionEnforced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 132);
        static final int TRANSACTION_isPermissionEnforced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 133);
        static final int TRANSACTION_isStorageLow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 134);
        static final int TRANSACTION_setApplicationHiddenSettingAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 135);
        static final int TRANSACTION_getApplicationHiddenSettingAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 136);
        static final int TRANSACTION_getPackageInstaller = (android.os.IBinder.FIRST_CALL_TRANSACTION + 137);
        static final int TRANSACTION_setBlockUninstallForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 138);
        static final int TRANSACTION_getBlockUninstallForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 139);
        static final int TRANSACTION_getKeySetByAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 140);
        static final int TRANSACTION_getSigningKeySet = (android.os.IBinder.FIRST_CALL_TRANSACTION + 141);
        static final int TRANSACTION_isPackageSignedByKeySet = (android.os.IBinder.FIRST_CALL_TRANSACTION + 142);
        static final int TRANSACTION_isPackageSignedByKeySetExactly = (android.os.IBinder.FIRST_CALL_TRANSACTION + 143);
        static final int TRANSACTION_addOnPermissionsChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 144);
        static final int TRANSACTION_removeOnPermissionsChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 145);
        static final int TRANSACTION_grantDefaultPermissionsToEnabledCarrierApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 146);
        static final int TRANSACTION_isPermissionRevokedByPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 147);
        static final int TRANSACTION_getPermissionControllerPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 148);
        static final int TRANSACTION_recoverySystemInstallPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 149);
        static final int TRANSACTION_pmScanPackageLI = (android.os.IBinder.FIRST_CALL_TRANSACTION + 150);
        static final int TRANSACTION_registerLaunchedObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 151);
        static final int TRANSACTION_unRegisterLaunchedObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 152);
        static final int TRANSACTION_setLaunchedPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 153);
        static final int TRANSACTION_adbDialog = (android.os.IBinder.FIRST_CALL_TRANSACTION + 154);
        static final int TRANSACTION_authentificationFeatureMap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 155);
        static final int TRANSACTION_getFeatureMap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 156);
        static final int TRANSACTION_setPermByList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 157);
        static final int TRANSACTION_queryDefaultPreferredActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 158);
        static final int TRANSACTION_clearSystemCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 159);
        static final int TRANSACTION_onBootPhase = (android.os.IBinder.FIRST_CALL_TRANSACTION + 160);
        static final int TRANSACTION_getAccessCtrlResolveInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 161);
        static final int TRANSACTION_getLastDisabledAppCaller = (android.os.IBinder.FIRST_CALL_TRANSACTION + 162);
        static final int TRANSACTION_getInstallingPackageState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 163);
    }
//[+LEUI] [REQ][LEUI-8957] [xulei] add
//for support double app
